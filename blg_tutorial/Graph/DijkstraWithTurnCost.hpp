#ifndef DIJKSTRA_WITH_TURN_COST_HPP
#define DIJKSTRA_WITH_TURN_COST_HPP
...
void DijkstraWithTurnCost(const Graph &graph, Vertex s, Vertex t, DistanceMap &distance, DirectionMap &direction, PredecessorMap &predecessor, int turnCost)
{
    ...
    distance[s] = 0;
    pq.push(std::make_pair(distance[s], s));
...
#endif // DIJKSTRA_WITH_TURN_COST_HPP
